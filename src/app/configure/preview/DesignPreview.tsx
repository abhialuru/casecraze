...
import { COLORS, MATERIALS, MODELS } from '@/validators/options'
...
function DesignPreview({configuration}:{configuration: Configuration}) {
  ...
  <div className='md:flex gap-14 mx-5 md:ml-5 lg:ml-44 mb-10'>
       ...
       <p className='flex justify-between items-center'><span>Order total</span><span>₹{totalPrice}</span></p>       </div>
        </div>
        <div className='my-5 text-sm flex justify-end'>
          <button className='text-white flex items-center bg-green-700 px-4 py-1 rounded-sm'>
